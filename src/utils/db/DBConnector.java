...
//    private final static String DB_URL = "localhost";	  //TRSServer数据库URL
    ...
    public final static String serverTable = "AS$22$43$1";        //TRSServer数据库名
    public final static String groupType = "内部网站";            //数据库类型  分为  外部网站、内部网站、微博、微信
    ...
    //    public final static String biaodashi = desktop + "信息报表\\0510外网表达式.txt";        //外网表达式
